    ...
    <Fragment>
      <div className='calculator-container'>
        ...
        <div className='p-6 bg-white dark:bg-gray-900'>
          <div className='mb-4'>
            <div className='text-sm text-gray-500 dark:text-gray-400 mb-2'>Expresión:</div>
            <Input
              value={expression}
              onChange={(e) => setExpression(e.target.value)}
              onKeyDown={handleKeyPress}
              placeholder='Write the math expression...'
          ...
          <div className='flex items-center justify-between mb-4 text-sm'>
            <div className='text-gray-600 dark:text-gray-400'>
              Memoria: <span className='font-mono'>{memory}</span>
            </div>
        ...
        {isHistoryOpen && (
          <div className='absolute right-0 top-0 bottom-0 w-96 bg-white dark:bg-gray-900 border-l dark:border-gray-700 shadow-xl z-50 overflow-hidden'>
            <div className='p-4 border-b dark:border-gray-700 flex justify-between items-center'>
              <h3 className='text-po text-lg font-semibold'>History</h3>
              <div className='flex space-x-2'>
                <Button
                  className='text-po'
                  size='sm'
            ...
            <div className='overflow-y-auto h-[calc(100vh-120px)] p-4'>
              {history.length === 0 ? (
                <div className='text-center text-po text-gray-500 dark:text-gray-400 py-8'>
                ...
                history.map((item) => (
                  <div
                    key={item.id}
                    className='text-po mb-4 p-3 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer'
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className='text-po text-lg mb-1'>{item.expression}</div>
                    <div className='text-po text-2xl font-bold text-primary'>= {item.result}</div>
                  </div>
                ))
              )}
            </div>
